    ...
    <div className="space-y-5">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Controle de pagamentos e obrigações financeiras</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="kpi-card border border-emerald-200 bg-emerald-50">
          <p className="kpi-card-label mb-2">Pago</p>
          <p className="text-xl font-bold text-emerald-700 tabular">{formatCurrency(totalPago)}</p>
        </div>
      </div>
